...
class RestClient extends base_1.Base {
    /**
     * Get T-Pin on your registered mobile number using this API.
     * @method generateTpin
     */
    generateTpin() {
        let endpoint = `/${routes_1.Routes.EDIS}`;
     ...
     */
    postEdisTpinForm(tpinForm) {
        let endpoint = `/${routes_1.Routes.EDIS_FORM}`;
        return this.request(endpoint, {
            method: "POST",
     ...
     */
    getEdisStatusAndInquiry() {
        let endpoint = `/${routes_1.Routes.EDIS_INQUIRE_ISIN}`;
        return this.request(endpoint);
    }
    /**
     ...
     */
    getFundLimit() {
        let endpoint = `/${routes_1.Routes.FUND_LIMIT}`;
        return this.request(endpoint);
    }
    /**
     ...
     */
    getDailyHistoricalData(dailyHistoricalDataRequest) {
        let endpoint = `/${routes_1.Routes.HISTORICAL}`;
        return this.request(endpoint, {
            method: "POST",
     ...
     */
    getIntradayHistoricalData(intradayHistoricalDataRequest) {
        let endpoint = `/${routes_1.Routes.HISTORICAL_INTRADAY}`;
        return this.request(endpoint, {
            method: "POST",
    ...
    placeOrder(orderDetail) {
        let endpoint = `/${routes_1.Routes.ORDERS}`;
        return this.request(endpoint, {
            method: "POST",
     ...
     * @param {OrderDetail} orderDetail
     */
    modifyOrder(orderId, orderDetail) {
        let endpoint = `/${routes_1.Routes.ORDERS}/${orderId}`;
        return this.request(endpoint, {
            method: "PUT",
            body: JSON.stringify(orderDetail),
        });
     ...
     * @param {OrderDetail} orderDetail
     */
    placeSliceOrder(orderDetail) {
        let endpoint = `/${routes_1.Routes.ORDERS_SLICING}`;
        return this.request(endpoint, {
            method: "POST",
            body: JSON.stringify(orderDetail),
        });
     ...
     */
    getOrderByCorrelationId(correlationId) {
        let endpoint = `/${routes_1.Routes.ORDERS_BY_CORRELATION}/${correlationId}`;
        return this.request(endpoint);
    }
    /**
     ...
     */
    getTradeBook() {
        let endpoint = `/${routes_1.Routes.TRADE_BOOK}`;
        return this.request(endpoint);
    }
    /**
     ...
     * @param {String} orderId
     */
    getTradesOfAnOrderByOrderId(orderId) {
        let endpoint = `/${routes_1.Routes.TRADE_BOOK}/${orderId}`;
        return this.request(endpoint);
    }
    /**
     ...
     */
    getHoldings() {
        let endpoint = `/${routes_1.Routes.HOLDINGS}`;
        return this.request(endpoint);
    }
    /**
     ...
     */
    getPositions() {
        let endpoint = `/${routes_1.Routes.POSITIONS}`;
        return this.request(endpoint);
    }
    /**
     ...
     */
    convertPosition(convertPositionRequest) {
        let endpoint = `/${routes_1.Routes.POSITIONS_CONVERT}`;
        return this.request(endpoint, {
            method: "POST",
