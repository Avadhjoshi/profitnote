...
export declare class DepthLevel {
    bidOrders: number;
    bidQuantity: number;
    bidPrice: number;
    askPrice: number;
...
export declare class OiDataResponse {
    type: string;
    responseCode: number;
...
export declare class MarketStatusResponse {
    type: string;
    responseCode: number;
    status: string;
    constructor(type: string, responseCode: number, status: string);
}
export declare class MarketDepthResponse {
    type: string;
    responseCode: number;
    ltp: number;
...
export declare class PrevCloseResponse {
    type: string;
    responseCode: number;
    exchangeSegment: number;
    securityId: number;
...
export declare class TickerResponse {
    type: string;
    responseCode: number;
    exchangeSegment: number;
    securityId: number;
